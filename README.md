...
- mettre en valeur mes **projets réalisés** en formation et en autonomie
- offrir un **CV téléchargeable**
- proposer une expérience utilisateur moderne, claire et fluide
- intégrer un **système multilingue complet (FR / EN / RO)** codé en JavaScript
...
- **JavaScript (Vanilla)** : interactions, i18n, menu mobile, thème clair/sombre  
- **Canvas API** : fond animé avec particules  
- **Font Awesome & Devicon** : icônes professionnelles  
...
- **Jeu Le Seau d’Eau** — logique en JavaScript  
...
- present my **projects** developed during training and personal work
- provide a **downloadable CV**
- offer a clear, modern and smooth **user experience**
- include a complete **multilanguage system (FR / EN / RO)** built in JavaScript
...
- **JavaScript** – interactivity, i18n, dark/light theme, mobile navigation  
...
- a arăta **proiectele dezvoltate** în formare și individual
- a oferi un **CV descărcabil**
- a crea o experiență modernă și clară pentru vizitatori
- a integra un sistem **multilingv (FR / EN / RO)** realizat complet în JavaScript
